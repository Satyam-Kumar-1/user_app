        ...
        <nav>
            ...
            <div>
                <ul id='navbar' className={bardisplay ? "#navbar" : "#navbar active"}>
                    ...
                    <li>
                        <Link to="/signup" className={location.pathname === '/signup' ? "active" : "inactive"}>SignUp</Link>
                    </li>
                    <li>
                        <Link to="/login" className={location.pathname === '/login' ? "active" : "inactive"}>Login</Link>
                    </li>
                    <li>
